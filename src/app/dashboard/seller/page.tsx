  ...
  return (
    <div className="page-container">
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#8899bb', fontSize: '0.9rem' }}>Manage your quotations and browse chemical products</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
        <div className="glass-card" style={{ padding: '1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
            ...
            <Link href="/dashboard/seller/quotations" style={{ fontSize: '0.8rem', color: '#38aaf6', textDecoration: 'none' }}>View all →</Link>
          </div>
        ...
        <div className="glass-card" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', gap: '1rem', background: 'linear-gradient(135deg, rgba(14,144,226,0.05), rgba(52,211,153,0.05))' }}>
          <div style={{ width: 60, height: 60, background: 'linear-gradient(135deg, #0e90e2, #34d399)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Package size={30} color="white" />
          </div>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#e8edf8' }}>Browse Products</h3>
          <p style={{ fontSize: '0.875rem', color: '#8899bb', lineHeight: 1.6 }}>Search through {productCount ?? 0} chemical products, select quantities, and submit quotations</p>
          <Link href="/dashboard/seller/catalog" className="btn-primary">Go to Catalog →</Link>
        </div>
      </div>
    </div>
  )
